...
_.extend(ObserveMultiplexer.prototype, {
  ...
  _applyCallback: function (callbackName, args) {
    ...
    self._queue.queueTask(function () {
      ...
      self._cache.applyChange[callbackName].apply(null, EJSON.removedClone(args));
      ...
      _.each(_.keys(self._handles), function (handleId) {
        ...
        callback && callback.apply(null,
          handle.nonMutatingCallbacks ? EJSON.removedClone(args) : EJSON.clone(args));
      });
    });
  },
  ...
  _sendAdds: function (handle) {
    ...
    self._cache.docs.forEach(function (doc, id) {
      ...
      const { _id, ...fields } = handle.nonMutatingCallbacks ? EJSON.removedClone(doc)
        : EJSON.clone(doc);
      if (self._ordered)
