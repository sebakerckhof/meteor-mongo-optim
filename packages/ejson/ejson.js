...
let clones = 0;
const logClones = () => {
  console.log(`Total clones: ${clones}. Clones added: ${clonesAdded}, Clones removed: ${clonesRemoved}. Diff: ${clonesAdded - clonesRemoved}`);
}
EJSON.addedClone = (v) => {
  clonesAdded++;
  return EJSON.clone(v);
}
EJSON.removedClone = (v) => {
  clonesRemoved++;
  logClones();
  return v;
}
